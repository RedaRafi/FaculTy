 ...
 */
@Entity
public class DemandeReleveNote implements Serializable {
    ...
    @OneToMany(mappedBy = "demandeReleveNote")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DemandeReleveNote)) {
            return false;
        }
        DemandeReleveNote other = (DemandeReleveNote) object;
    ...
    public String toString() {
        return "bean.DemandeReleveNote[ id=" + id + " ]";
    }
